...
public enum ErrorCode {
    ...
    LIMIT_ONE_SKU(1054,"Only one sku setting for non-variant product",HttpStatus.CONFLICT),
    INVALID_CURSOR(1056,"Invailid_cursor",HttpStatus.BAD_REQUEST),
    DUPLICATE_SKU_OPTIONS(1054,"Duplication about options",HttpStatus.CONFLICT);
