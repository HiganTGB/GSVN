...
public enum ErrorCode {
    ...
    NOT_EXISTED(1011,"Item not existed",HttpStatus.BAD_REQUEST),
    VARIANT_HAS_LINKED_SKU(1012, "Cannot delete variant because it has linked SKUs", HttpStatus.CONFLICT);
