...
import com.gsvn.promotionservice.client.fallback.MediaClientFallbackFactory;
...
@FeignClient(name = "media-service", path = "/api/v1/media",fallbackFactory = MediaClientFallbackFactory.class)
