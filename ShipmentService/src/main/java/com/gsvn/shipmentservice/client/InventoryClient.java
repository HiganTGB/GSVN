...
import com.gsvn.shipmentservice.client.fallback.InventoryClientFallbackFactory;
...
@FeignClient(name = "inventory-service", path = "/api/v1",fallbackFactory = InventoryClientFallbackFactory.class,configuration = InternalFeignConfig.class )
