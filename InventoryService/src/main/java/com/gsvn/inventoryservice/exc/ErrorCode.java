package com.gsvn.inventoryservice.exc;
...
public enum ErrorCode {
    ...
    SKU_NOT_FOUND(1011, "SKU does not exist in system", HttpStatus.NOT_FOUND),
    INSUFFICIENT_STOCK(1012, "Insufficient physical stock in warehouse", HttpStatus.BAD_REQUEST),
    WAREHOUSE_NOT_FOUND(1013, "Warehouse not found", HttpStatus.NOT_FOUND),
    DUPLICATE_RECEIPT_CODE(1014, "Receipt code already exists", HttpStatus.BAD_REQUEST);
